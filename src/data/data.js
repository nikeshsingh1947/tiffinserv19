...
export const categories = [
  {
    ...
    name: 'Dal Makhni',
    image:
      'https://png.pngtree.com/png-vector/20240628/ourlarge/pngtree-dal-makhni-in-a-bowl-on-it-side-view-png-image_12786165.png',
  },
  {
    id: 2,
    name: 'Kadi Pakoda',
    image:
      "https://i.postimg.cc/CKG8B6K4/kadhi-pakora.png",
  },
  {
    id: 3,
    name: 'Rajma',
    image:
      'https://static.vecteezy.com/system/resources/previews/036/512/703/original/ai-generated-bowl-of-rajma-masala-on-transparent-background-png.png',
  },
  {
    id: 4,
    name: 'Chilli Paneer',
    image:
      'https://static.vecteezy.com/system/resources/previews/036/290/871/non_2x/ai-generated-chilli-paneer-with-a-transparent-background-ai-png.png',
  },
  {
    id: 5,
    name: 'Chole',
    image:
      'https://c8.alamy.com/comp/2E24HTH/chana-masala-or-chole-in-black-bowl-isolated-on-white-indian-cuisine-veg-chickpeas-curry-dish-asian-spicy-vegetarian-food-and-meal-top-view-2E24HTH.jpg',
  },
  {
    id: 6,
    name: 'Matar Paneer',
    image:
      'https://i.postimg.cc/pXgMcPfq/Mater-Paneer.png',
  },
  {
    id: 7,
    name: 'Kashmiri Dum Aloo',
    image:
      'https://i.postimg.cc/rFzqYhvF/Dum-Aloo.png',
  },
  {
    id: 8,
    name: 'Vej Pulao',
    image:
      'https://t3.ftcdn.net/jpg/02/06/88/10/360_F_206881043_fkgfikSC3BLAEJgHFIIJ67b97HQod3o8.jpg',
  },
];
